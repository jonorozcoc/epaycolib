...
final class AccessSdkTest extends TestCase
{
    protected $epayco;
    ...
    public function testCreateClient()
    {
        ...
        $client = $this->epayco->customer->create([
            'token_card' => $token,
            'name' => 'Joe Doe',
            'email' => 'joe@payco.co',
            'phone' => '3005234321',
    ...
    {
        $response = $this->epayco->plan->update('coursereact', [
            'interval_count' => 4,
        ]);
        $this->assertGreaterThanOrEqual(1, count($response));
    }
    ...
    {
        $response = $this->epayco->subscriptions->cancel([
    ...
    {
        $response = $this->epayco->bank->create([
            'bank' => '1007',
            'invoice' => '1472050778',
    ...
    public function testCashCreate()
    {
        ...
        $response = $this->epayco->cash->create('efecty', [
            'invoice' => '1472050778',
